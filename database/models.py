...
# декларируем таблицу для реализаии связи many2many между сущностями Post и Tag
tag_post = Table(
    "tag_post",
    Base.metadata,
...
# декларируем таблиу Comment
class Comment(Base):
    __tablename__ = "comment"
    id = Column(Integer, primary_key=True)
    # связываем таблицу Comments саму с собой, реализуя иерархию комментариев
